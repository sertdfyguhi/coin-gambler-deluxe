(() => {
  ...
  const riskLevels = {
    low: {
      ...
      10: [2.5, 2.2, 1.8, 1.2, 0.7, 0.35, 0.7, 1.2, 1.8, 2.2, 2.5],
      12: [3.0, 2.5, 2.0, 1.5, 1.0, 0.5, 0.35, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0],
      14: [
        3.0, 2.8, 2.3, 1.8, 1.2, 0.7, 0.35, 0.3, 0.35, 0.7, 1.2, 1.8, 2.3, 2.8,
        3.0,
      ],
      16: [
        3.5, 3.0, 2.5, 2.0, 1.4, 0.9, 0.5, 0.35, 0.3, 0.35, 0.5, 0.9, 1.4, 2.0,
        2.5, 3.0, 3.5,
      ],
    },
    medium: {
      // Balanced middle/edges. EV ~0.90-0.93
      8: [3, 2, 1.5, 1.0, 0.5, 1.0, 1.5, 2, 3],
      10: [5, 4, 2.0, 1.2, 0.9, 0.5, 0.9, 1.2, 2.0, 4, 5],
      12: [8, 6, 3.0, 1.5, 1.0, 0.8, 0.5, 0.8, 1.0, 1.5, 3.0, 6, 8],
      14: [
        12, 10, 5.0, 2.0, 1.2, 0.9, 0.7, 0.5, 0.7, 0.9, 1.2, 2.0, 5.0, 10, 12,
      ],
      16: [
        20, 15, 8.0, 3.0, 1.5, 1.0, 0.8, 0.6, 0.3, 0.6, 0.8, 1.0, 1.5, 3.0, 8.0,
        15, 20,
      ],
    },
    high: {
      ...
      16: [
        100, 40, 15.0, 4.0, 1.5, 0.6, 0.3, 0.1, 0, 0.1, 0.3, 0.6, 1.5, 4.0,
        15.0, 40, 100,
      ],
    },
  };
