(() => {
  ...
  const riskLevels = {
    low: {
      ...
      8: [0.5, 1.0, 1.5, 2.0, 2.5, 2.0, 1.5, 1.0, 0.5],
      10: [0.3, 0.7, 1.2, 1.8, 2.2, 2.5, 2.2, 1.8, 1.2, 0.7, 0.3],
      12: [0.2, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 2.5, 2.0, 1.5, 1.0, 0.5, 0.2],
      14: [
        0.1, 0.3, 0.7, 1.2, 1.8, 2.3, 2.8, 3.0, 2.8, 2.3, 1.8, 1.2, 0.7, 0.3,
        0.1,
      ],
      16: [
        0.1, 0.2, 0.5, 0.9, 1.4, 2.0, 2.5, 3.0, 3.5, 3.0, 2.5, 2.0, 1.4, 0.9,
        0.5, 0.2, 0.1,
      ],
    },
    medium: {
      ...
      16: [
        15, 20, 8.0, 3.0, 1.5, 1.0, 0.8, 0.6, 0.4, 0.6, 0.8, 1.0, 1.5, 3.0, 8.0,
        20, 15,
      ],
    },
    high: {
      ...
      16: [
        150, 40, 15.0, 4.0, 1.5, 0.6, 0.3, 0.1, 0.05, 0.1, 0.3, 0.6, 1.5, 4.0,
        15.0, 40, 150,
      ],
    },
  };
